...
> See the raw files, behind the curtain, [here](https://github.com/DefenseLogisticsAgency/DLA-Wiki-Approach). See the simple [markdown format](https://help.github.com/articles/basic-writing-and-formatting-syntax) of the first two sections of chapter one [here](https://defenselogisticsagency.github.io/DLA-Wiki-Approach/CHAPTER_ONE-LEGAL_ISSUES_SPECIFIC_TO_THE_COMMANDER.html#sources-of-command-authority)
---------
